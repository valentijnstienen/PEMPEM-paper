...
FILE_IDS_USED = range(0,1101)  #PEMPEM: range(0,2656), #WB (eStrada as base, OSM as trajectories): range(0,8001) #WB (OSM as base, eStrada as trajectories): range(0,1101)
MERGING = True
