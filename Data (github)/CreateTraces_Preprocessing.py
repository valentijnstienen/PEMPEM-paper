...
def createSubtrips(filename, file_ID, merging, fname = None):
    ...
    if merging: 
        ...
        if SAVE_STOPS: df_fromto.to_csv(FNAME_STOPS, sep = ";")
        subtrips.to_csv(fname, sep = ";")
...
"""---------------------------------------------------"""   
"""---------------------------------------------------"""   
createSubtrips(PATH_TO_RAW_GPSTRAJECTORIES, FILE_IDS_USED, merging = MERGING, fname = FNAME) 
