...
PATH_TO_RAW_GPSTRAJECTORIES = 'WorldBank/coordinates_ESTRADA_FULL_0609.csv' #PEMPEM: PEMPEM_data, #WB (eStrada as base, OSM as trajectories): coordinates_OSM_FULL_0609 #WB (OSM as base, eStrada as trajectories): coordinates_ESTRADA_FULL_0609 
